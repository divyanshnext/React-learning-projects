...
function App() {
  ...
  return (
    ...
    >
      ...
      <h1 class="text-5xl font-extrabold dark:text-white">Project04 - <small class="ms-2 font-semibold text-gray-500 dark:text-gray-400">BackGround-ColorChanger</small></h1>
